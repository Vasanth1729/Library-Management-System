			...
			if(!empty($studUsername)){
					...
					{	
						...
						{	
							...
							if($quantity != 0 && ($returnDate >= $issueDate)){
								$quantity = $quantity - 1;
            ...
            <div id = "bottomLayout">
                ...
                <form action="borrower.php" method = "POST">
                    <table id = "formLayout" cellspacing="10">
                        <tr id = "rowLayout"><td id="rowHeading"> Student Username :  </td><td><input type="text" name="studUsername" id = "input" required></td></tr>
                        <tr id = "rowLayout"><td id="rowHeading"> BookId :  </td><td><input type="text" name="bookId" id = "input" required></td></tr>
                        <tr id = "rowLayout"><td id="rowHeading"> Issue Date :  </td><td><input type="text" name="issueDate" id = "input" required></td></tr>
                        <tr id = "rowLayout"><td id="rowHeading"> Return Date :  </td><td><input type="text" name="returnDate" id = "input" required></td></tr>
                    </table>
