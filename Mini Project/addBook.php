	...
	if(!empty($username)){
		if($_SERVER["REQUEST_METHOD"] == "POST"){
			if(!empty($bookId)){
				...
				{	
					$sql = "INSERT INTO bookrecord VALUES('$bookId', '$title', '$authorName', '$category', '$cost', '$quantity')";
					if($conn->query($sql))
					{
						echo "<center style='color:#ffffff;'><p >New record is inserted successfully.</p><center>";
					}
					else
					{
            ...
            <div id = "bottomLayout">
                ...
                <form action="addBook.php" method = "post">
                    <table id = "formLayout" cellspacing="10">
                        <tr id = "rowLayout"><td id="rowHeading"> Book Id :  </td><td><input type="text" name="bookId" id = "input" required></td></tr>
                        <tr id = "rowLayout"><td id="rowHeading"> Title :  </td><td><input type="text" name="title" id = "input" required></td></tr>
                        <tr id = "rowLayout"><td id="rowHeading"> Author Name :  </td><td><input type="text" name="authorName" id = "input" required></td></tr>
						<tr id = "rowLayout"><td id="rowHeading"> Category :  </td><td><input type="text" name="category" id = "input" required></td></tr>
                        <tr id = "rowLayout"><td id="rowHeading"> Cost :  </td><td><input type="text" name="cost" id = "input" required></td></tr>
                        <tr id = "rowLayout"><td id="rowHeading"> Quantity :  </td><td><input type="text" name="quantity" id = "input" required></td></tr>
                    </table>
